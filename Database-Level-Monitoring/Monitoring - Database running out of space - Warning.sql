...
/****** Object:  Job [Coeo Monitoring - Database running out of space - Warning]    Script Date: 03/03/2023 14:16:39 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 03/03/2023 14:16:39 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Monitoring - Database running out of space - Warning', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Check if AG primary]    Script Date: 03/03/2023 14:16:39 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Check DB free space %]    Script Date: 03/03/2023 14:16:39 ******/
...
DECLARE @threshold float = 0.8 --Used space threshold: default 80%
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every 10 Minutes', 
		...
		@schedule_uid=N'e9705b26-985a-48a3-8979-f1cd32cda45b'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
